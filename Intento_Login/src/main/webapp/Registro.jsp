...
<form class="formulario" action="Control_login" method="post">
        ...
        <div class="input-contenedor">
            ...
            <input type="text" name="RNombre" placeholder="Nombre Completo">
        ...
        <div class="input-contenedor">
            ...
            <input type="text" name=RCorreo placeholder="Correo Electronico">
        ...
        <input type="submit" name="CrearUsuario" value="Registrate" class="button">
