        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-7 px-5 pt-5">
                ...
                <form>
                    <div class="from-row">
                        <div class="col-lg-7">
                            <input type="email" placeholder="email@email.com" class="form-control my-3 p-4">
                        </div>
                    </div>
                    <div class="from-row">
                        <div class="col-lg-7">
                    ...
                    <div class="from-row">
                        <div class="col-lg-7">
                            <button type="button" class="btn1 mt-3px mb-5" >Ingresar</button>
                        </div>
                    </div>
                    <a style="color:#FFFFFF" href="#">Olvide mi Contraseña</a>
                    <div class="from-row">
                        <div class="col-lg-7">
                        <p style="color:#FFFFFF"> No tiene una cuenta? </p> <a button class="btn1 mt-" href="usuarios.html"> Registrarse aqui</button></a> 
                </form>
