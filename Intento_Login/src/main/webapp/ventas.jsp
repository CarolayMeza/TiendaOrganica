...
<body>
			...
			<form action="Controlador_ventas" method="post">
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="input-group my-5">
							<h2>consec.</h2>
							<span id="codigoVenta"><%=dao.consecutivoVenta() %></span>
							
							<input type="text" class="form-control" placeholder="consec."
								name="consecu" value="<%=codigoV%>">
						</div>
					</div>
				</div>
			</form>
						...
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									<input type="number" name="totalIva1" id="totalIva1" placeholder="totalIva1" value="0" hidden=""  >
									<input type="number" name="ValorVP1" id="ValorVP1" placeholder="ValorVP1" value="0" hidden="">
						...
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									<input type="number" name="totalIva2" id="totalIva2" placeholder="totalIva2" value="0" hidden="" >
									<input type="number" name="ValorVP2" id="ValorVP2" placeholder="ValorVP2" value="0" hidden=""  >
							</div>
						</div>
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									<input type="number" name="totalIva3" id="totalIva3" placeholder="totalIva3" value="0" hidden="" >
									<input type="number" name="ValorVP3" id="ValorVP3" placeholder="ValorVP3" value="0" hidden="" >
							</div>
						</div>
					...
					<div class="col-lg my-3 ">
						<span class="input-group-btn ">
							<button type="submit" class="btn btn-success btn-lg"
								name="calcularT" hidden="" >Calcular</button>
						</span>
						<div class="col-lg my-3 ">
							...
							<input type="hidden" class="form-control" placeholder=""
									name="prueba1"  value="<%=ced%>" >
									
									<input type="hidden" class="form-control" placeholder=""
									name="prueba2"  value="<%=cedU%>" >
								<input type="hidden" class="form-control" placeholder=""
									name="prueba3"  value="<%=codigoV%>" >
						
						
									
									
									<input type="hidden" class="form-control" placeholder=""
									name="CANT1" id="CANT1"  value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="COD1"  value="<%=codP%>" >
								<input type="hidden" class="form-control" placeholder=""
									name="TOTAL1" id="TOTAL1"   value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="VENTA1" id="VENTA1"   value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="IVA1" id="IVA1"  value="0" >
									
									
									<input type="hidden" class="form-control" placeholder=""
									name="CANT2" id="CANT2"  value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="COD2"  value="<%=codP2 %>" >
								<input type="hidden" class="form-control" placeholder=""
									name="TOTAL2" id="TOTAL2"  value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="VENTA2" id="VENTA2" value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="IVA2" id="IVA2" value="0" >
									
									
									<input type="hidden" class="form-control" placeholder=""
									name="CANT3" id="CANT3" value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="COD3"  value="<%=codP3%>" >
								<input type="hidden" class="form-control" placeholder=""
									name="TOTAL3" id="TOTAL3" value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="VENTA3" id="VENTA3"  value="0" >
									<input type="hidden" class="form-control" placeholder=""
									name="IVA3" id="IVA3"  value="0" >
	...
	function Calculos() {
		...
		/////////////////////////////////////////////////////////////// PRUEBA TOTALES
			...
			document.getElementById("TOTAL1").value = precio * cantidad;
			
			var precio = parseFloat(document.getElementById("precio2").value);
			var cantidad = parseFloat(document.getElementById("cantidad2").value);
			document.getElementById("TOTAL2").value = precio * cantidad;
			 document.getElementById("CANT2").value = cantidad;
			 
			 
			var precio = parseFloat(document.getElementById("precio3").value);
			var cantidad = parseFloat(document.getElementById("cantidad3").value);
			document.getElementById("TOTAL3").value = precio * cantidad;
		...
		var iva1 = parseFloat(document.getElementById("iva1").value);
		iva1 = (iva1 / 100) +1
		document.getElementById("IVA1").value = valorT1 - (valorT1 / iva1);
		var iva2 = parseFloat(document.getElementById("iva2").value);
		iva2 = (iva2 / 100) + 1
		document.getElementById("IVA2").value = valorT2 - (valorT2 / iva2);
		var iva3 = parseFloat(document.getElementById("iva3").value);
		iva3 = (iva3 / 100) + 1
		document.getElementById("IVA3").value = valorT3 - (valorT3 / iva3);
	
/////////////////////////////////////////////////////////////////////FIN

		document.getElementById("ValorVP1").value =  (valorT1 / iva1);
		document.getElementById("ValorVP2").value =  (valorT2 / iva2);
		document.getElementById("ValorVP3").value =  (valorT3 / iva3);
		
		///////////////////////////////////////////////////////////// PRUEBAS VENTA
		document.getElementById("VENTA1").value =  (valorT1 / iva1);
		document.getElementById("VENTA2").value =  (valorT2 / iva2);
		document.getElementById("VENTA3").value =  (valorT3 / iva3);
	///////////////////////////////////////////////////////////////////////FIN
