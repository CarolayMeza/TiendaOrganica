                ...
                <div class="col-lg-4">
                    <div class="input-group my-5">
                        ...
                        <span class="input-group-btn ">
                            <button class="btn btn-success col-sm" type="button" name="consultarC">
                                Consultar</button>
                        </span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="input-group ">
                        ...
                        <span class="input-group-btn ">
                            <button class="btn btn-success col-sm" type="button" name="consultarE">
                                Consultar</button>
                        </span>
                    </div>
                </div>
                    ...
                    <div class="col-lg ">
                        <div class="input-group my-3">
                            <input type="text" class="form-control"
                                ...
                                <button class="btn btn-success col-sm" type="button" name="ConsultarP">
                                    Consultar</button>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-lg-2">
                    ...
                    <div class="col-lg ">
                        <div class="input-group my-3">
                            ...
                            <span class="input-group-btn ">
                                <button class="btn btn-success col-sm" type="button" name="calcular">
                                    Consultar</button>
                            </span>
                        </div>
                    </div>
